        ...
        >
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TabButton
                        label={constants.screens.search} icon={icons.search}
                    ...
                    <TabButton
                        label={constants.screens.cart} icon={icons.cart}
                    ...
                    <TabButton
                        label={constants.screens.favourite} icon={icons.favourite}
                    ...
                    <TabButton
                        label={constants.screens.notification} icon={icons.notification}
